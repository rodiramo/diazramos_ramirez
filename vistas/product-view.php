   ...
   <aside class="container-fluid space">
      ...
      <div class="row" style="justify-content: center; align-items: center;">
         <div class="col-md-4 img-productview">
            <img src="imgs/producto-<?= $product->product_img; ?>" alt="product">
         </div>
         <div class="col-md-6">
            
      <h2 class="p-name"><?= $product->product_name; ?></h2>
      <div class="linea2" style="margin-bottom: 10px;"></div>
      
            <div class="product-detail-content">
               <p class="p-category"><?= $product->product_category; ?></p>

               <div class="p-features">
                  <h4>Plant Family</h4>
                  <p class="p-name"><?= $product->product_type; ?></p>
                  <h4>About this product</h4>
                  <p class="p-description"> <?= $product->product_description ?></p>
               </div>
               <ul class="spe_ul"></ul>
